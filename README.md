...
**Prototype / playable experiment**

Waterphys is a small experimental project. It is useful as a portfolio piece for showing physics-style gameplay prototyping, Godot/GDScript usage, and interactive system design.

## Features

- Diggable terrain
- Simple 2D water simulation
- Falling ball objects
- Goal-fill detection
- Restartable levels
- Basic puzzle/prototype UI
- Mouse-based interaction

## Controls

- **Left click:** drop a ball
- **Shift + left click / middle mouse:** add water
